...
namespace OpenCardsEditor
{
    public partial class FormEditor : Form
    {
        ...
        //Fingerprinting and legitimacy tracking
        //------------------------------------------------------------------------------------------
        public void UpdateMergeChain()
        {
            //Decrypt existing Merge Chain
            //Add new entries to Merge Chain
            //Encrypt Marge Chain
        }
        
        //Encryption for fingerprinting
        //------------------------------------------------------------------------------------------
